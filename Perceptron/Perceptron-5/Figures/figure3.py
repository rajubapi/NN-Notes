...
class Perceptron():
    ...
    def learn(self, input_vector, desired_output):
        ...
        return drawNoBiasGif(self.Weights)
...
imageio.mimwrite('./Gifs/WithoutBias.gif', [perceptron_binary.learn(data, desired) for i in range(perceptron_binary.epochs)], fps=1)